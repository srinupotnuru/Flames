package com.example.flamesfree;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void dofalmes(View view) {
        ...
        if(e=='M'){
            Intent i=new Intent(this,Marriage.class);
            startActivity(i);
        }
        if(e=='F'){
            Intent i=new Intent(this,Friendds.class);
            startActivity(i);
        }
        if(e=='L'){
        ...
        if(e=='A'){
            Intent i=new Intent(this,Affection.class);
            startActivity(i);
        }
        if(e=='E'){
            Intent i=new Intent(this,Enemies.class);
            startActivity(i);
        }
        if(e=='S'){
            Intent i=new Intent(this,Siblings.class);
            startActivity(i);
        }
    }
